...
neghidprobs = zeros(numcases,numhid);%hidden state of each phase

posprods    = zeros(numdims,numhid);
negprods    = zeros(numdims,numhid);%expectation value of each phase

vishidinc  = zeros(numdims,numhid);
hidbiasinc = zeros(1,numhid);
visbiasinc = zeros(1,numdims);%weight update
